...
def generate_blog_pages(posts):
    ...
    <script>
      ...
      gtag('config', '{ga_id_e}');
        ...
        if related:
            items = ''.join(
                f'<li><a href="blog-{post_slug(r)}.html">{html_mod.escape(r.get("title", "Health Article"))}</a></li>'
                for r in related
            )
            related_html = f"""
        ...
        if formatted_date:
            date_meta_html = f"""
                    <span class="blog-meta-item">
                      ...
                      <time datetime="{html_mod.escape(published_at)}">{html_mod.escape(formatted_date)}</time>
                    </span>
...
<head>
    ...
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="{title_e} | Ibn Sina Hospital">
        ...
        <div class="container">
          <article class="premium-blog-post">
            ...
            <header class="blog-article-hero">
              ...
              <p class="blog-article-summary">{summary_e}</p>

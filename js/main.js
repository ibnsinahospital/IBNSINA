...
function initializeBlogShareButtons(scope) {
  ...
  const shareButtons =
    root.querySelectorAll('.blog-share-button');
  ...
  shareButtons.forEach(button => {
    ...
    button.addEventListener('click', async () => {
      ...
      const shareText =
        document.querySelector('.blog-article-title')?.textContent.trim() ||
        document.title;
...
document.addEventListener(
  ...
  () => {
    ...
    if (postContainer) {
      ...
      if (!slug) {
        ...
        (async () => {
          ...
          initializeBlogShareButtons(postContainer);
    ...
    // ========================================================
    // STATIC BLOG ARTICLE PAGES
    // /blog/blog-[slug].html — the share buttons here are baked into
    // the static HTML (not rendered by the block above), so wire them
    // up separately. No-op on any page without share buttons.
    // ========================================================
